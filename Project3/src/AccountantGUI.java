...
public class AccountantGUI extends JFrame {
    ...
    public AccountantGUI() {
        ...
        setTitle("SPECIALIZED ACCOUNTANT APPLICATION - (CNT 4714 Project 3)");
        setSize(1000, 850);  // Increased height
        setMinimumSize(new Dimension(800, 800));  // Increased minimum height
        setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        setLayout(new BorderLayout(10, 5));  // Reduced vertical gap
        getContentPane().setBackground(PANEL_BACKGROUND);

        // Create Main Content Panel.
        JPanel mainContent = new JPanel(new BorderLayout(10, 3)); // Reduced vertical gap further
        mainContent.setBorder(BorderFactory.createEmptyBorder(3, 10, 3, 10)); // Minimal vertical padding
        mainContent.setBackground(PANEL_BACKGROUND);

        // Create Login Panel with Enhanced Styling and GridBagLayout.
        ...
        loginPanel.setPreferredSize(new Dimension(1000, 250)); // Reduced height further

        // Setup GridBagConstraints with Reduced Spacing.
        GridBagConstraints gbc = new GridBagConstraints();
        gbc.insets = new Insets(2, 5, 2, 5); // Minimal spacing
        gbc.fill = GridBagConstraints.HORIZONTAL;
        gbc.anchor = GridBagConstraints.WEST;
        gbc.weightx = 1.0; // Add weight to ensure proper horizontal distribution
        ...
        gbc.gridx = 1;
        gbc.weightx = 0.8;
        dbPropertiesDropdown = new JComboBox<>(new String[]{"operationslog.properties"});
        dbPropertiesDropdown.setSelectedIndex(0);
        dbPropertiesDropdown.setEnabled(false);
        styleComboBox(dbPropertiesDropdown);
        loginPanel.add(dbPropertiesDropdown, gbc);

        // Add Database Properties Label.   
        gbc.gridx = 0;
        gbc.gridy = 1;
        gbc.weightx = 0.2;
        ...
        gbc.gridx = 1;
        gbc.weightx = 0.8;
        userPropertiesDropdown = new JComboBox<>(new String[]{"theaccountant.properties"});
        userPropertiesDropdown.setSelectedIndex(0);
        userPropertiesDropdown.setEnabled(false);
        ...
        // Create Button Panel with FlowLayout for Centering.
        JPanel buttonPanel = new JPanel(new FlowLayout(FlowLayout.CENTER, 20, 0));
        buttonPanel.setBackground(PANEL_BACKGROUND);
        
        // Style Buttons with Smaller Dimensions.
        ...
        // Style Query Panel with Adjusted Height.
        ...
        // Style Query Area with Adjusted Height.
        ...
        // Style SQL Command Buttons with Adjusted Spacing.
        ...
        // Style Results Panel with Adjusted Height.
        ...
        // Style Table with Adjusted Height.
        ...
        // Style Results Buttons with Adjusted Spacing.
    ...
    private void executeQuery() {
        ...
        // Check if accountant is trying to run non-SELECT query
        if (userPropertiesDropdown.getSelectedItem().equals("theaccountant.properties")) {
            if (!sql.toUpperCase().trim().startsWith("SELECT")) {
                showErrorDialog("Permission Denied: Accountants can only run SELECT queries.");
                return;
            }
        }
    ...
    private void showSQLErrorDialog(SQLException e) {
        ...
        // Customize error messages for better readability.
    ...
    private void logOperation(String operationType) {
        if (loggingConnection == null) return; // Skip logging if no logging connection
    ...
    private JButton createStyledButton(String text, Color bgColor) {
        ...
        button.setFont(new Font("Segoe UI", Font.BOLD, 11));  // Slightly smaller font
        ...
        button.setPreferredSize(new Dimension(160, 30));  // Default smaller size
    ...
    // Update styleComboBox method.
    private void styleComboBox(JComboBox<?> comboBox) {
        comboBox.setFont(new Font("Segoe UI", Font.PLAIN, 14));
        comboBox.setBackground(Color.WHITE);
        comboBox.setPreferredSize(new Dimension(300, 35)); // Reduced height
    ...
    // Update table styling in the constructor where table is created.
